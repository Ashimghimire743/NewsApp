...
const Home = (props) => {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                const response = await fetch(`https://newsapi.org/v2/top-headlines?country=${props.country}&q=${props.searchQuery}&apiKey=38f9594212fb4ac4a37e9a36c1e8194e`);
                if (!response.ok) {
    ...
    return (
        <div className="container p-4">
            <h1 className="bg-gray-100 text-2xl font-extrabold mb-8 text-center shadow-lg p-6 rounded-lg">Top Headlines</h1>
